...
export class CrearDepartamentoDto {
    ...
    @ApiProperty({
        example: "En este departamento aun no tenemos sucursales",
    ...
    @ApiProperty({
        ...
        example: 'Este es un departamento es muy bonito'
    })
    ...
    @IsString({ message: 'El id del país debe ser un texto' })
    @IsUUID('all', { message: 'El id del país debe ser un UUID válido' })
    uuidPais!: string;
